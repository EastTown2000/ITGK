...
siffer = 5
print('Venligst gi inn et flyttall med minst', siffer, 'siffer både før og etter .')
...
ftall = float(input('Skriv inn et flyttall: '))
dtall = int(input('Hvor mange desimaler er ønskelig?'))
print('Tallet du skrev er', ftall, 'og med', dtall, 'desimaler blir det til', round(ftall, dtall))
